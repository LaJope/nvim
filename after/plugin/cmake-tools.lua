...
require("cmake-tools").setup {
  ...
  cmake_generate_options = { "-DCMAKE_EXPORT_COMPILE_COMMANDS=1"}, --, "-DCMAKE_SYSTEM_NAME=Windows", "-DCMAKE_CXX_COMPILER=x86_64-w64-mingw32-g++"}, -- this will be passed when invoke `CMakeGenerate`
